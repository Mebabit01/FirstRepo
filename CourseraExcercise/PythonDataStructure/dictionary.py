...
# 1. Build the dictionary of email frequencies
for line in handle:
    ...
    # Use .get() to provide a fallback value of 0 if the email isn't in counts yet
    counts[email] = counts.get(email, 0) + 1

# 2. Loop through the dictionary to find the maximum count
bigcount = None
bigword = None
...
# 3. Print the top sender and their total count
